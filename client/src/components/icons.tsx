...
// Feather icons (MIT licensed) — stroke-based, so they inherit color via
// currentColor and stay crisp at small sizes without needing brand assets.
...
export function IconMoreVertical({ size = 14 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
